...
from .forms import AnchorPhotoForm, TestPhotoForm
from .utils.photo import same_person

app_bp = Blueprint('home', __name__, template_folder='templates')
...
def home():
    ...
    if anchor_photo_form.validate_on_submit(
    ) and anchor_photo_form.submit_anchor.data:
    ...
    if test_photo_form.validate_on_submit(
    ) and test_photo_form.submit_test.data:
    ...
    if anchor_photo and test_photo:
        match = same_person(f'{current_app.root_path}/static/{anchor_photo}',
